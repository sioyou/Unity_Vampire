...
public class UI_GameResultPopup : UI_Base
{
    ...
    public override bool Init()
    {
        ...
        GetButton((int)Buttons.StatisticsButton).gameObject.BindEvent(OnClickStartisticsButton);
        GetButton((int)Buttons.ConfirmButton).gameObject.BindEvent(OnClickCofirmButton);
    ...
    void OnClickStartisticsButton()
    {
        Debug.Log("OnClickStatistButton");
    }

    void OnClickCofirmButton()
    {
